...
const NavIcons = () => {
      ...
      // const login = async ()=>{
      //   const loginRequesData = wixClient.auth.generateOAuthData(
      //     "http://localhost:3000"
      //   )
      //   console.log(loginRequesData)

      //   localStorage.setItem("oAuthRedirectData",JSON.stringify(loginRequesData));
      //   const {authUrl} = await wixClient.auth.getAuthUrl(loginRequesData);
